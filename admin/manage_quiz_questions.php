...
/* Reload quiz data with a fresh SELECT (don’t reuse the UPDATE $stmt) */
$reload = $pdo->prepare("
    SELECT tq.*,
           CASE tq.content_type
               WHEN 'category' THEN c.name
...
<div class="quiz-questions-management">
    ...
    <div class="question-card">
        ...
        <?php if (empty($questions)): ?>
            ...
            <div id="questions-list">
                <?php
                // Use an explicit counter so numbers are always 1,2,3,… regardless of array indexes
                $question_number = 1;
    ...
    <div class="question-meta">
        Points: <?php echo (int)$question['points']; ?> •
